  ...
  const applyHandler = async () => {
    try {
      ...
      const { data } = await axios.post(
        `${backendUrl}/api/users/apply-job`,   // ✅ fixed endpoint
        { jobId: jobData._id },
        ...
        <div className="bg-white text-black rounded-lg w-full">
          <div className="flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border-sky-400 rounded-xl">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="text-center md:text-left text-neutral-800">
                ...
                <div className="flex flex-auto flex-wrap max-md:justify-center gap-y-2 gap-6 items-center text-gray-600 mt-2">
            ...
            <div className="flex flex-col justify-center text-end text-sm max-md:mx-auto max-md:text-center">
              <button
                ...
                className="bg-blue-600 p-2 px-10 text-white rounded"
              >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start">
            <div className="w-full lg:w-2/3 ">
              ...
              <button
                onClick={applyHandler}
                className="bg-blue-600 p-2 px-10 text-white rounded mt-10"
              >
                {isAlreadyApplied ? "Already Applied" : "Apply Now"}
              </button>
            </div>
